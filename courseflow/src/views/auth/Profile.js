             ...
             <CenterContainer >
                ...
                <StyledCard>
                    <StyledCard.Body>
                        ...
                        <StyledIcon> {currentUser.email.charAt(0).toUpperCase()} </StyledIcon>
                        {currentUser.email}
             
                        <StyledForm.Group id="update">
                            <StyledButton className="btn-secondary" onClick={() => setOpen(!open)}>
                                Settings
                            </StyledButton >
                            ...
                            <StyledCollapse in={open}>
                                <StyledForm id="update-form">
                                    ...
                                    <StyledButton disabled={loading} className="btn-secondary" onClick={handleUpdate}>
                                        Update
                                    </StyledButton >
                                </StyledForm>
                            </StyledCollapse>
                        ...
                        <StyledButton disabled={loading} variant="danger" onClick={handlelogout}>
                            Logout
                        </StyledButton >
